...
///
/// Converts a [CameraImage] to [image_lib.Image] in RGB format
///
...
imglib.Image convertJpegToImage(CameraImage cameraImage) =>
    imglib.decodeJpg(cameraImage.planes[0].bytes)!;
